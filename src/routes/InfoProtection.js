  ...
  <>
    ...
    <div style={{ margin: 10 }}>
      <div style={{ marginBottom: 30, marginTop: 20 }}>
        본 개인정보처리방침은 어플리케이션 프로필 탭의 설정화면에서도 확인하실
        수 있습니다.
      </div>
      <div>
        ...
        조작, 저장, 공개 및 본 개인 정보 보호 정책에 명시된 귀하의 정보를
        제공하는 것에 대해 동의하게 됩니다. 귀하의 거주 국가나 정보의 출처에
        관계 없이, 귀하의 정보는 서비스가 운영되는 다른 모든 국가에서 사용될 수
        있습니다.
      </div>
      <div style={{ fontSize: 15, fontWeight: "700", marginTop: 30 }}>
        1. 수집하는 개인정보의 항목 및 수집방법
      </div>
      <div style={{ marginTop: 20, fontSize: 12, fontWeight: "700" }}>
        가. 수집하는 개인정보의 항목
      </div>
      ...
      <div style={{ marginLeft: 10, marginRight: 10 }}>
        ...
        <div style={{ marginTop: 7, fontSize: 10 }}>
          ...
          스마트폰 또는 모바일 디바이스에 캐싱된 정보는 변경 또는 삭제되지 않을
          수 있습니다.
        </div>
      ...
      <div style={{ marginLeft: 10, marginRight: 10 }}>
        <div style={{ marginTop: 7, fontSize: 10 }}>
          ...
          불량회원(소행성 운영수칙을 위반하여 계약해지된 영구이용정지 회원)의
          부정 이용방지와 비인가 사용방지, 가입의사 확인, 가입 및 가입횟수 제한,
          만14세 미만 아동 개인정보 수집 시 법정 대리인 동의여부 확인, 추후 법정
          대리인 본인확인, 법령이나 이용약관을 위반하여 발생하는 분쟁 조정을
          위한 기록보존, 불만처리 등, 고지사항 전달
        </div>
      </div>
      <div style={{ marginTop: 20, fontSize: 12, fontWeight: "700" }}>
      ...
      <div style={{ marginTop: 20, fontSize: 12 }}>
        회사는 관계 법령에 따른 위탁계약 시 개인정보가 안전하게 관리될 수 있도록
        필요한 사항을 규정하고 있으니 안심하시기 바라며 회사의 개인정보 위탁처리
      ...
      <div style={{ marginRight: 10, marginLeft: 10 }}>
        ...
        <div style={{ marginTop: 7, fontSize: 10 }}>- 수탁업무 : 본인확인</div>
      </div>
      <div style={{ fontSize: 15, fontWeight: "700", marginTop: 30 }}>
        5. 개인정보의 보유 및 이용기간
      </div>
      ...
      <div style={{ marginRight: 10, marginLeft: 10 }}>
        <div style={{ marginTop: 7, fontSize: 10 }}>- 부정이용기록</div>
      ...
      <div style={{ marginRight: 10, marginLeft: 10 }}>
        <div style={{ marginTop: 7, fontSize: 10 }}>- 본인확인에 관한 기록</div>
        <div style={{ marginRight: 17, marginLeft: 17 }}>
          <div
            style={{
              marginTop: 7,
      ...
      <div style={{ marginRight: 10, marginLeft: 10 }}>
        <div style={{ marginTop: 7, fontSize: 10 }}>- 방문에 관한 기록</div>
        <div style={{ marginRight: 17, marginLeft: 17 }}>
          <div
            style={{
              marginTop: 7,
      ...
      <div style={{ marginLeft: 10, marginRight: 10 }}>
        <div style={{ marginTop: 7, fontSize: 10 }}>
          - 이용자는 언제든지 개인정보를 조회하거나 수정할 수 있으며 가입해지를
          요청할 수도 있습니다.
        </div>
        <div style={{ marginTop: 7, fontSize: 10 }}>
          - 이용자의 개인정보 조회, 수정을 위해서는 서비스내 "계정관리" 변경을,
          가입해지를 위해서는 서비스내 “회원탈퇴”를 클릭하여 직접 탈퇴가
          가능합니다.
        </div>
        <div style={{ marginTop: 7, fontSize: 10 }}>
      ...
      <div style={{ marginTop: 7, fontSize: 12 }}>
        귀하께서는 회사의 서비스를 이용하시면서 발생하는 모든 개인정보보호 관련
        민원을 개인정보관리책임자 혹은 담당부서로 신고하실 수 있습니다. 서비스
        내 설정 기능의 고객지원을 통해 문의해주시면 감사하겠습니다.
      </div>
      <div style={{ marginRight: 10, marginLeft: 10 }}>
        <div style={{ marginTop: 7, fontSize: 10 }}>- 책임자</div>
        <div style={{ marginRight: 17, marginLeft: 17 }}>
          <div
            style={{
              marginTop: 7,
